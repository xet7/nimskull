/* Generated by the Nim Compiler v0.1.0-dev.20180 */
var framePtr = null;
var excHandler = 0;
...
function makeNimstrLit(c_33556818) {
      var result = [];
  for (var i = 0; i < c_33556818.length; ++i) {
    result[i] = c_33556818.charCodeAt(i);
  }
  return result;
...
function toJSStr(s_33556824) {
                    var Temporary5;
            var Temporary7;

  var result_33556825 = null;

    var res_33556859 = newSeq_33556842((s_33556824).length);
    var i_33556860 = 0;
    var j_33556861 = 0;
    Label1: do {
        Label2: while (true) {
        if (!(i_33556860 < (s_33556824).length)) break Label2;
          var c_33556862 = s_33556824[i_33556860];
          if ((c_33556862 < 128)) {
          res_33556859[j_33556861] = String.fromCharCode(c_33556862);
          i_33556860 += 1;
          }
          else {
            var helper_33556874 = newSeq_33556842(0);
            Label3: do {
                Label4: while (true) {
                if (!true) break Label4;
                  var code_33556875 = c_33556862.toString(16);
                  if ((((code_33556875) == null ? 0 : (code_33556875).length) == 1)) {
                  helper_33556874.push("%0");;
                  }
                  else {
                  helper_33556874.push("%");;
                  }
                  
                  helper_33556874.push(code_33556875);;
                  i_33556860 += 1;
                    if (((s_33556824).length <= i_33556860)) Temporary5 = true; else {                      Temporary5 = (s_33556824[i_33556860] < 128);                    }                  if (Temporary5) {
                  break Label3;
                  }
                  
                  c_33556862 = s_33556824[i_33556860];
                }
            } while (false);
++excHandler;
            Temporary7 = framePtr;
            try {
            res_33556859[j_33556861] = decodeURIComponent(helper_33556874.join(""));
--excHandler;
} catch (EXCEPTION) {
 ...
 --excHandler;
            framePtr = Temporary7;
            res_33556859[j_33556861] = helper_33556874.join("");
    ...
    if (res_33556859.length < j_33556861) { for (var i = res_33556859.length ; i < j_33556861 ; ++i) res_33556859.push(null); }
               else { res_33556859.length = j_33556861; };
    result_33556825 = res_33556859.join("");
...
function addInt(a_33556957, b_33556958) {
        var result = a_33556957 + b_33556958;
...
function mnewString(len_33556910) {
        return new Array(len_33556910);
  

  
}

function chckRange(i_33557206, a_33557207, b_33557208) {
      var Temporary1;

  var result_33557209 = 0;

  BeforeRet: do {
      if (!(a_33557207 <= i_33557206)) Temporary1 = false; else {        Temporary1 = (i_33557206 <= b_33557208);      }    if (Temporary1) {
    result_33557209 = i_33557206;
    break BeforeRet;
    }
    else {
    raiseRangeError();
...
function nimCopy(dest_33557157, src_33557158, ti_33557159) {
  var result_33557168 = null;

    switch (ti_33557159.kind) {
    case 21:
    case 22:
    case 23:
    case 5:
      if (!(isFatPointer_33557148(ti_33557159))) {
      result_33557168 = src_33557158;
      }
      else {
        result_33557168 = [src_33557158[0], src_33557158[1]];
      }
      
      break;
    case 19:
            if (dest_33557157 === null || dest_33557157 === undefined) {
        dest_33557157 = {};
      }
      else {
        for (var key in dest_33557157) { delete dest_33557157[key]; }
      }
      for (var key in src_33557158) { dest_33557157[key] = src_33557158[key]; }
      result_33557168 = dest_33557157;
    
      break;
    case 18:
    case 17:
      if (!((ti_33557159.base == null))) {
      result_33557168 = nimCopy(dest_33557157, src_33557158, ti_33557159.base);
      }
      else {
      if ((ti_33557159.kind == 17)) {
      result_33557168 = (dest_33557157 === null || dest_33557157 === undefined) ? {m_type: ti_33557159} : dest_33557157;
      }
      else {
        result_33557168 = (dest_33557157 === null || dest_33557157 === undefined) ? {} : dest_33557157;
      }
      }
      nimCopyAux(result_33557168, src_33557158, ti_33557159.node);
      break;
    case 4:
    case 16:
            if(ArrayBuffer.isView(src_33557158)) { 
        if(dest_33557157 === null || dest_33557157 === undefined || dest_33557157.length != src_33557158.length) {
          dest_33557157 = new src_33557158.constructor(src_33557158);
        } else {
          dest_33557157.set(src_33557158, 0);
        }
        result_33557168 = dest_33557157;
      } else {
        if (src_33557158 === null) {
          result_33557168 = null;
        }
        else {
          if (dest_33557157 === null || dest_33557157 === undefined || dest_33557157.length != src_33557158.length) {
            dest_33557157 = new Array(src_33557158.length);
          }
          result_33557168 = dest_33557157;
          for (var i = 0; i < src_33557158.length; ++i) {
            result_33557168[i] = nimCopy(result_33557168[i], src_33557158[i], ti_33557159.base);
          }
        }
      }
    ...
    case 28:
            if (src_33557158 !== null) {
        result_33557168 = src_33557158.slice(0);
      }
...
function chckIndx(i_33557201, a_33557202, b_33557203) {
      var Temporary1;

  var result_33557204 = 0;

  BeforeRet: do {
      if (!(a_33557202 <= i_33557201)) Temporary1 = false; else {        Temporary1 = (i_33557201 <= b_33557203);      }    if (Temporary1) {
    result_33557204 = i_33557201;
    break BeforeRet;
    }
    else {
    raiseIndexError(i_33557201, a_33557202, b_33557203);
    }
...
function subInt(a_33556961, b_33556962) {
        var result = a_33556961 - b_33556962;
    checkOverflowInt(result);
    return result;
...
function mulInt(a_33556965, b_33556966) {
        var result = a_33556965 * b_33556966;
    checkOverflowInt(result);
    return result;
...
function nimMax(a_33557015, b_33557016) {
    var Temporary1;

  var result_33557017 = 0;

  BeforeRet: do {
    if ((b_33557016 <= a_33557015)) {
    Temporary1 = a_33557015;
    }
    else {
    Temporary1 = b_33557016;
    }
    
    result_33557017 = Temporary1;
    break BeforeRet;
  } while (false);

  return result_33557017;

}

function nimMin(a_33557011, b_33557012) {
    var Temporary1;

  var result_33557013 = 0;

  BeforeRet: do {
    if ((a_33557011 <= b_33557012)) {
    Temporary1 = a_33557011;
    }
    else {
    Temporary1 = b_33557012;
    }
    
    result_33557013 = Temporary1;
    break BeforeRet;
  } while (false);

  return result_33557013;

}

function addChar(x_33557275, c_33557276) {
    x_33557275.push(c_33557276);
...
function newSeq_33556842(len_33556844) {
  var result_33556845 = [];

    result_33556845 = new Array(len_33556844); for (var i = 0 ; i < len_33556844 ; ++i) { result_33556845[i] = null; }
  return result_33556845;
...
function checkOverflowInt(a_33556955) {
        if (a_33556955 > 2147483647 || a_33556955 < -2147483648) raiseOverflow();
...
function isFatPointer_33557148(ti_33557149) {
  var result_33557150 = false;

  BeforeRet: do {
    result_33557150 = !((ConstSet1[ti_33557149.base.kind] != undefined));
    break BeforeRet;
  } while (false);
...
function nimCopyAux(dest_33557161, src_33557162, n_33557163) {
    switch (n_33557163.kind) {
    case 0:
      break;
    case 1:
            dest_33557161[n_33557163.offset] = nimCopy(dest_33557161[n_33557163.offset], src_33557162[n_33557163.offset], n_33557163.typ);
    
      break;
    case 2:
          for (var i = 0; i < n_33557163.sons.length; i++) {
      nimCopyAux(dest_33557161, src_33557162, n_33557163.sons[i]);
    }
    ...
    case 3:
            dest_33557161[n_33557163.offset] = nimCopy(dest_33557161[n_33557163.offset], src_33557162[n_33557163.offset], n_33557163.typ);
      for (var i = 0; i < n_33557163.sons.length; ++i) {
        nimCopyAux(dest_33557161, src_33557162, n_33557163.sons[i][1]);
      }
...
function raiseIndexError(i_33556765, a_33556766, b_33556767) {
    var Temporary1;

    if ((b_33556767 < a_33556766)) {
    Temporary1 = makeNimstrLit("index out of bounds, the container is empty");
    }
    else {
    Temporary1 = (makeNimstrLit("index ") || []).concat(HEX24_318767107(i_33556765) || [],makeNimstrLit(" not in ") || [],HEX24_318767107(a_33556766) || [],makeNimstrLit(" .. ") || [],HEX24_318767107(b_33556767) || []);
    }
