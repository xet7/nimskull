/* Generated by the Nim Compiler v0.1.0-dev.20257 */
var framePtr = null;
var excHandler = 0;
...
function makeNimstrLit(c_33556803) {
      var result = [];
  for (var i = 0; i < c_33556803.length; ++i) {
    result[i] = c_33556803.charCodeAt(i);
  }
  return result;
...
function toJSStr(s_33556809) {
                    var Temporary5;
            var Temporary7;

  var result_33556810 = null;

    var res_33556844 = newSeq_33556827((s_33556809).length);
    var i_33556845 = 0;
    var j_33556846 = 0;
    Label1: do {
        Label2: while (true) {
        if (!(i_33556845 < (s_33556809).length)) break Label2;
          var c_33556847 = s_33556809[i_33556845];
          if ((c_33556847 < 128)) {
          res_33556844[j_33556846] = String.fromCharCode(c_33556847);
          i_33556845 += 1;
          }
          else {
            var helper_33556859 = newSeq_33556827(0);
            Label3: do {
                Label4: while (true) {
                if (!true) break Label4;
                  var code_33556860 = c_33556847.toString(16);
                  if ((((code_33556860) == null ? 0 : (code_33556860).length) == 1)) {
                  helper_33556859.push("%0");;
                  }
                  else {
                  helper_33556859.push("%");;
                  }
                  
                  helper_33556859.push(code_33556860);;
                  i_33556845 += 1;
                    if (((s_33556809).length <= i_33556845)) Temporary5 = true; else {                      Temporary5 = (s_33556809[i_33556845] < 128);                    }                  if (Temporary5) {
                  break Label3;
                  }
                  
                  c_33556847 = s_33556809[i_33556845];
                }
            } while (false);
++excHandler;
            Temporary7 = framePtr;
            try {
            res_33556844[j_33556846] = decodeURIComponent(helper_33556859.join(""));
--excHandler;
} catch (EXCEPTION) {
 ...
 --excHandler;
            framePtr = Temporary7;
            res_33556844[j_33556846] = helper_33556859.join("");
    ...
    result_33556810 = res_33556844.join("");

  return result_33556810;

}

function raiseException(e_33556651, ename_33556652) {
    if ((e_33556651.name == null)) {
...
function addInt(a_33556942, b_33556943) {
...
function mnewString(len_33556895) {
        return new Array(len_33556895);
  

  
}

function chckRange(i_33557191, a_33557192, b_33557193) {
      var Temporary1;

  var result_33557194 = 0;

  BeforeRet: do {
      if (!(a_33557192 <= i_33557191)) Temporary1 = false; else {        Temporary1 = (i_33557191 <= b_33557193);      }    if (Temporary1) {
    result_33557194 = i_33557191;
    break BeforeRet;
    }
    else {
    raiseRangeError();
...
function nimCopy(dest_33557142, src_33557143, ti_33557144) {
  var result_33557153 = null;

    switch (ti_33557144.kind) {
    case 21:
    case 22:
    case 23:
    case 5:
      if (!(isFatPointer_33557133(ti_33557144))) {
      result_33557153 = src_33557143;
      }
      else {
        result_33557153 = [src_33557143[0], src_33557143[1]];
      }
      
      break;
    case 19:
            if (dest_33557142 === null || dest_33557142 === undefined) {
        dest_33557142 = {};
      }
      else {
        for (var key in dest_33557142) { delete dest_33557142[key]; }
      }
      for (var key in src_33557143) { dest_33557142[key] = src_33557143[key]; }
      result_33557153 = dest_33557142;
    
      break;
    case 18:
    case 17:
      if (!((ti_33557144.base == null))) {
      result_33557153 = nimCopy(dest_33557142, src_33557143, ti_33557144.base);
      }
      else {
      if ((ti_33557144.kind == 17)) {
      result_33557153 = (dest_33557142 === null || dest_33557142 === undefined) ? {m_type: ti_33557144} : dest_33557142;
      }
      else {
        result_33557153 = (dest_33557142 === null || dest_33557142 === undefined) ? {} : dest_33557142;
      }
      }
      nimCopyAux(result_33557153, src_33557143, ti_33557144.node);
      break;
    case 4:
    case 16:
            if(ArrayBuffer.isView(src_33557143)) { 
        if(dest_33557142 === null || dest_33557142 === undefined || dest_33557142.length != src_33557143.length) {
          dest_33557142 = new src_33557143.constructor(src_33557143);
        } else {
          dest_33557142.set(src_33557143, 0);
        }
        result_33557153 = dest_33557142;
      } else {
        if (src_33557143 === null) {
          result_33557153 = null;
        }
        else {
          if (dest_33557142 === null || dest_33557142 === undefined || dest_33557142.length != src_33557143.length) {
            dest_33557142 = new Array(src_33557143.length);
          }
          result_33557153 = dest_33557142;
          for (var i = 0; i < src_33557143.length; ++i) {
            result_33557153[i] = nimCopy(result_33557153[i], src_33557143[i], ti_33557144.base);
          }
        }
      }
    ...
    case 28:
            if (src_33557143 !== null) {
        result_33557153 = src_33557143.slice(0);
      }
...
function chckIndx(i_33557186, a_33557187, b_33557188) {
      var Temporary1;

  var result_33557189 = 0;

  BeforeRet: do {
      if (!(a_33557187 <= i_33557186)) Temporary1 = false; else {        Temporary1 = (i_33557186 <= b_33557188);      }    if (Temporary1) {
    result_33557189 = i_33557186;
    break BeforeRet;
    }
    else {
    raiseIndexError(i_33557186, a_33557187, b_33557188);
    }
...
function subInt(a_33556946, b_33556947) {
...
function mulInt(a_33556950, b_33556951) {
...
function nimMax(a_33557000, b_33557001) {
    var Temporary1;

  var result_33557002 = 0;

  BeforeRet: do {
    if ((b_33557001 <= a_33557000)) {
...
function nimMin(a_33556996, b_33556997) {
    var Temporary1;

  var result_33556998 = 0;

  BeforeRet: do {
    if ((a_33556996 <= b_33556997)) {
    Temporary1 = a_33556996;
    }
    else {
    Temporary1 = b_33556997;
    }
    
    result_33556998 = Temporary1;
    break BeforeRet;
  } while (false);
...
function addChar(x_33557260, c_33557261) {
    x_33557260.push(c_33557261);
...
function add_33556403(x_33556404, x_33556404_Idx, y_33556405) {
          if (x_33556404[x_33556404_Idx] === null) { x_33556404[x_33556404_Idx] = []; }
      var off = x_33556404[x_33556404_Idx].length;
      x_33556404[x_33556404_Idx].length += y_33556405.length;
      for (var i = 0; i < y_33556405.length; ++i) {
        x_33556404[x_33556404_Idx][off+i] = y_33556405.charCodeAt(i);
      }
...
function unhandledException(e_33556647) {
    ...
    buf_33556648[0].push.apply(buf_33556648[0], makeNimstrLit("Error: unhandled exception: "));;
    ...
    buf_33556648[0].push.apply(buf_33556648[0], makeNimstrLit(" ["));;
    add_33556403(buf_33556648, 0, e_33556647.name);
    buf_33556648[0].push.apply(buf_33556648[0], makeNimstrLit("]\x0A"));;
...
function checkOverflowInt(a_33556940) {
        if (a_33556940 > 2147483647 || a_33556940 < -2147483648) raiseOverflow();
...
function isFatPointer_33557133(ti_33557134) {
  var result_33557135 = false;

  BeforeRet: do {
    result_33557135 = !((ConstSet1[ti_33557134.base.kind] != undefined));
    break BeforeRet;
  } while (false);
...
function nimCopyAux(dest_33557146, src_33557147, n_33557148) {
    switch (n_33557148.kind) {
    case 0:
      break;
    case 1:
            dest_33557146[n_33557148.offset] = nimCopy(dest_33557146[n_33557148.offset], src_33557147[n_33557148.offset], n_33557148.typ);
    
      break;
    case 2:
          for (var i = 0; i < n_33557148.sons.length; i++) {
      nimCopyAux(dest_33557146, src_33557147, n_33557148.sons[i]);
    }
    ...
    case 3:
            dest_33557146[n_33557148.offset] = nimCopy(dest_33557146[n_33557148.offset], src_33557147[n_33557148.offset], n_33557148.typ);
      for (var i = 0; i < n_33557148.sons.length; ++i) {
        nimCopyAux(dest_33557146, src_33557147, n_33557148.sons[i][1]);
      }
...
function raiseIndexError(i_33556750, a_33556751, b_33556752) {
    var Temporary1;

    if ((b_33556752 < a_33556751)) {
    Temporary1 = makeNimstrLit("index out of bounds, the container is empty");
    }
    else {
    Temporary1 = (makeNimstrLit("index ") || []).concat(HEX24_318767107(i_33556750) || [],makeNimstrLit(" not in ") || [],HEX24_318767107(a_33556751) || [],makeNimstrLit(" .. ") || [],HEX24_318767107(b_33556752) || []);
    }
